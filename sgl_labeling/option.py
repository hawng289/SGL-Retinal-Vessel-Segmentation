...
parser.add_argument('--dataset', type=str, default='DRIVE',
                    help='dataset mode for dataloader')
...
parser.add_argument('--marker', type=str, default='',
                    help='Marker while saving the results..')
...
# Option for Wide Activation Super Resolution (WDSR)
parser.add_argument('--block_feats', type=int, default=256,
                    help='whole number of channels inside the residual blocks')
