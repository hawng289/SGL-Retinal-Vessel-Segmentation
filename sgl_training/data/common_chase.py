...
def get_patch(hr, ve_r, te_r, patch_size=256, deform = True, train=True, random_toggle=False):
    ...
    if train:
        ...
        ret = [hr_t, ve_t, te_t, dp, ve_thin, ve_thick]
    else:
    #if True:
        ...
        ret = [hr_img, ve_img, ve_img, dp_img, ve_thin, ve_thick]
